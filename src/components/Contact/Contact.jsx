...
const contactInfo = [
  {
    icon: Mail,
    label: 'Email',
    value: 'info@thedevside.com',
    href: 'mailto:info@thedevside.com',
  },
  {
    icon: Phone,
    label: 'Phone',
    value: '(605) 550-0828',
    href: 'tel:+16055500828',
  },
  {
    icon: MapPin,
    label: 'Location',
    value: 'South Dakota, USA',
    href: null,
  },
];
    ...
    try {
      ...
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          from_name: 'The Dev Side Portfolio',
        }),
      });
        ...
        <div className="contact-content">
          ...
          >
            ...
            <div className="social-links">
              ...
              <a
                href="https://www.linkedin.com/in/scott-ymker-244ab81ab"
                target="_blank"
                rel="noopener noreferrer"
                className="social-link"
                aria-label="LinkedIn"
